"""
Django settings for udesign project.
...
ALLOWED_HOSTS = ['udesign.pythonanywhere.com']
...
AUTH_USER_MODEL = 'contest.CustomUser' #customising user
ROOT_URLCONF = 'udesign.urls'
...
WSGI_APPLICATION = 'udesign.wsgi.application'
